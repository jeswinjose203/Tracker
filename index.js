...
<script type='text/javascript'>
    ...
    xhr.open("POST", "https://app-b646f867-130c-4b79-a543-55b63122da7e.cleverapps.io/bus_no_1/data");
    ...
    xhr.open("POST", "https://app-b646f867-130c-4b79-a543-55b63122da7e.cleverapps.io/bus_no_2/data");
    xhr.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
    xhr.send(JSON.stringify({ lat: position.coords.latitude, lon: position.coords.longitude }));
    }
